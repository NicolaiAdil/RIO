...
from state_estimator.utils import _skew, _exp_so3, _project_to_SO3
...
class ErrorState_KalmanFilter:
    """
    Error State Kalman Filter with quaternion nominal attitude and 15D error state:
